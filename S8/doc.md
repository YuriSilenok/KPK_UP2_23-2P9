...
| count_student | Список студентов | Не обязательно | Список целых чисел |  | Пустой список |
...
| count_student | Список целых чисел |
...
| Параметр | Пояснение | Обязательность | Тип | Ограничение | Значение по умолчанию |
|---|---|---|---|---|---|
| count_student | Список студентов | Обязательно | Список целых чисел |  | Пустой список |
...
| count_student | Список | Строка | "1" - равно 1, "1,3" - от 1 до 3, "1," - от 1, ",3" - до 3. Включительно |
