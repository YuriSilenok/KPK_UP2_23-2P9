...
### 3. Отпуск (Vacation) (получение сущности по ID возможно только списком для конкретного сотрудника)
...
#### 3.4 Получить список отпусков по ID Сотрудника
**Параметры запроса:**
...
### 4. Больничный (Sick Leave) (получение сущности по ID возможно только списком для конкретного сотрудника)
...
#### 4.4 Получить список больничных по ID сотрудника
**Параметры запроса:**
...
* поля employee_id являются ссылками на сторонний сервис и технически не являются внешними ключами
