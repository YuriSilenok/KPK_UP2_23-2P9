...
| abbreviation | Краткая аббревиатура отделения | Обязательно | Строка | Уникальное, только заглавные буквы, максимум 20 символов | — |
...
| abbreviation | Краткая аббревиатура отделения | Опционально | Строка | Уникальное, только заглавные буквы, максимум 20 символов |
...
Выполняет логическое удаление отделения. Физически запись из базы данных не удаляется.
