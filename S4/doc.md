...
|----------|----------------|-----|-------------|----------------------|
| `id_role` | Обязательно | Целое число | от 1 до 6 (1-Админ,2-Директор,3-Завуч,4-Преподаватель,5-Студент,6-Родитель) | |
| `method` | Обязательно | Строка | | |
| `url` | Обязательно | Строка | Поддерживает шаблоны: `*` или `{id}` | |
...
| `url` | Не обязательно | Строка | Поддерживает шаблоны | `None` |
...
|----------|-----|----------|
| `role_id` | Целое число | Фильтр по ID роли (1-6). Необязательный |
